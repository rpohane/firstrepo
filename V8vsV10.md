---
title: Differences in AzCopy v8.1 and AzCopy v10 | Microsoft Docs
description: AzCopy v8.1 is the previous generation of a command-line utility that you can use to copy data to, from, or between storage accounts. This article helps you understand and transition to AzCopy v10.
author: ripohane
ms.service: storage
ms.topic: conceptual
ms.date: 09/09/2019
...
# Differences in AzCopy v8.1 and AzCopy v10

AzCopy is a command-line utility that you can use to copy blobs or files to or from a storage account. This article helps you understand the differences in connecting to your storage account and transferring files between v8.1 and v10.
...
dfs is used if you are downloading a filesystem.

To see a list of commands in v10, type `azcopy -h` and then press the ENTER key.
